...
If you see that the processing time of certain requests is slow while its CPU usage is high (e.g. taking more than 1000ms while 65% of time spent on CPU), you may consider using a profiler like [Blackfire](/administration/integrations/blackfire.md) to troubleshoot the application performance issue.
